        ...
        describe('Checking if Coder', function () {
            it('first children should be a Style', function () {
                var children = template.children[0],
                    ...
                    testStyle = 'div.'+templateId+'{margin:5px;padding:15px;border:solid green 2px}.header.'+templateId+'{color:green}.header.'+templateId+':hover{color:#8b0000}table.'+templateId+'{width:100%}table.'+templateId+' tr.'+templateId+' td.'+templateId+'{padding:5px 10px;border:solid 1px #ccc}.label.'+templateId+'{background:#ccc;border-radius:5px;font-size:.7em;color:#fff;padding:3px 10px;display:inline-block}.test.'+templateId+'>.'+templateId+'{padding:3px 5px;margin:5px;border:solid 1px #ccc;border-radius:4px}';
                console.log(children.data.style);
